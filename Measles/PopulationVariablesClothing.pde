...
//
void populationVariablesClothing() {
  //Population of Image
  pic1 = loadImage("../Images Used/winter-hat.png"); //Dimensions: width 512, height 241
  pic2 = loadImage("../Images Used/scarf.png"); //Dimensions: width 512, height 186
  ...
  imageX1 = width*1/10;
  imageY1 = height*0;
  imageWidth1 = (width-1)*4/5; //CANVAS (0,0) means point doesn't match to rectangle, missing outline on two sides
  imageHeight1 = (height-1)*1/3;
  imageX2 = width*0;
  imageY2 = (height-1)*2/3;
  imageWidth2 = width-1; //CANVAS (0,0) means point doesn't match to rectangle, missing outline on two sides
  imageHeight2 = height*1/2;
  //
...
}//End populationVariablesClothing